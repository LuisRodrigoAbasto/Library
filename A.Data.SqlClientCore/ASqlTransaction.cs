...
namespace A.Data.SqlClientCore
{
    public class ASqlTransaction : IDisposable
    {
        ...
        //
        // Resumen:
        //     Gets the Microsoft.Data.SqlClient.SqlConnection object associated with the transaction,
        //     or null if the transaction is no longer valid.
        //
        // Valor:
        //     The Microsoft.Data.SqlClient.SqlConnection object associated with the transaction.
        //
        // Comentarios:
        ...
        //     object associated with a particular transaction created by <xref:Microsoft.Data.SqlClient.SqlConnection.BeginTransaction%2A>.
        ...
        //
        // Comentarios:
        //     ## Remarks The <xref:Microsoft.Data.SqlClient.SqlTransaction.Commit%2A> method
        ...
        //     or rolling back a <xref:Microsoft.Data.SqlClient.SqlTransaction>. Both `Commit`
        //     and <xref:Microsoft.Data.SqlClient.SqlTransaction.Rollback%2A> generates an <xref:System.InvalidOperationException>
        ...
        //     The following example creates a <xref:Microsoft.Data.SqlClient.SqlConnection>
        //     and a <xref:Microsoft.Data.SqlClient.SqlTransaction>. It also demonstrates how
        //     to use the <xref:Microsoft.Data.SqlClient.SqlTransaction.Commit%2A>, <xref:Microsoft.Data.SqlClient.SqlConnection.BeginTransaction%2A>,
        //     and <xref:Microsoft.Data.SqlClient.SqlTransaction.Rollback%2A> methods. The transaction
        ...
        //
        // Comentarios:
        //     ## Remarks The <xref:Microsoft.Data.SqlClient.SqlTransaction.Rollback%2A> method
        ...
        //     The transaction can only be rolled back from a pending state (after <xref:Microsoft.Data.SqlClient.SqlConnection.BeginTransaction%2A>
        //     has been called, but before <xref:Microsoft.Data.SqlClient.SqlTransaction.Commit%2A>
        ...
        //     ## Examples The following example creates a <xref:Microsoft.Data.SqlClient.SqlConnection>
        //     and a <xref:Microsoft.Data.SqlClient.SqlTransaction>. It also demonstrates how
        //     to use the <xref:Microsoft.Data.SqlClient.SqlConnection.BeginTransaction%2A>,
        //     <xref:Microsoft.Data.SqlClient.SqlTransaction.Commit%2A>, and <xref:Microsoft.Data.SqlClient.SqlTransaction.Rollback%2A>
        ...
        //
        // Comentarios:
        //     ## Remarks <xref:Microsoft.Data.SqlClient.SqlTransaction.Save%2A> method is equivalent
        ...
        //     implementations of the <xref:Microsoft.Data.SqlClient.SqlConnection.BeginTransaction%2A>
        //     method. Savepoints offer a mechanism to roll back parts of transactions. You
        //     create a savepoint using the <xref:Microsoft.Data.SqlClient.SqlTransaction.Save%2A>
        //     method, and then later call the <xref:Microsoft.Data.SqlClient.SqlTransaction.Rollback%2A>
